        ...
        <div className="dashboard-hero mb-4 d-flex justify-content-between align-items-end">
          <div>
            <h2 className="fw-bold mb-1 text-dark">
              📋 {isAdmin ? "Quản lý Hệ thống" : "Dashboard Nhân viên"}
            </h2>
            <p className="text-muted mb-0">
              Xin chào, <strong>{userProfile?.username || "Bạn"}</strong>. Chúc
          ...
          <div className="text-end d-none d-md-block">
            <Badge
              bg="light"
              text="dark"
              className="border px-3 py-2 rounded-3 shadow-sm">
                  ...
                  <Card className="border-0 shadow-sm rounded-4 h-100 overflow-hidden">
                    <Card.Body className="p-4">
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        <div
                          className={`p-2 rounded-3 bg-${card.color} bg-opacity-10 text-${card.color}`}>
                          {card.icon}
                        </div>
              ...
              <Col lg={4}>
                <Card className="border-0 shadow-sm rounded-4 h-100 bg-primary text-white p-2">
                  <Card.Body className="d-flex flex-column justify-content-center p-4">
                    <h6 className="opacity-75 text-uppercase fw-bold small mb-2">
                      Tổng kết Năm {new Date().getFullYear()}
                    </h6>
                    <h2 className="fw-bold mb-3">
                      {stats.quickStats.confirmedYear}{" "}
                      <span className="h5 fw-normal">Đơn đã duyệt</span>
                    </h2>
                    <hr className="bg-white opacity-25" />
                    <p className="small mb-0">
                      Hệ thống ghi nhận hiệu suất tăng trưởng tốt trong năm nay.
                      Tiếp tục phát huy!
                    </p>
                ...
                <Card className="border-0 shadow-sm rounded-4 h-100">
                  <Card.Header className="bg-white p-4 border-0 d-flex justify-content-between align-items-center">
                    <h5 className="mb-0 fw-bold d-flex align-items-center gap-2">
                      <Activity size={18} className="text-primary" /> Hoạt động
                      Thuê đồ 7 ngày
                    </h5>
                  </Card.Header>
                ...
                <Card className="border-0 shadow-sm rounded-4 overflow-hidden">
                  <Card.Body className="p-0">
                    <Row className="g-0">
                      <Col
                        md={4}
                        className="border-end p-4 bg-light bg-opacity-50">
                        ...
                        <h3 className="fw-bold mb-1">
                          {stats.quickStats.totalRevenue?.toLocaleString()}đ
                        </h3>
                        <p className="text-muted small">
                          Ghi nhận từ các đơn đã hoàn thành
                        </p>
                      </Col>
                          ...
                          <div>
                            ...
                            <div className="h4 fw-bold mb-0">
                              {stats.quickStats.totalBookings > 0
                                ? Math.round(
                                    (stats.quickStats.confirmedYear /
                                      stats.quickStats.totalBookings) *
                                      100,
                                  )
                                : 0}
                              %
